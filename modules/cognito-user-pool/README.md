...
| <a name="input_domain"></a> [domain](#input\_domain) | Custom domain for Cognito Hosted UI | <pre>object({<br/>    mode = string<br/>    cognito_hosted = optional(object({<br/>      prefix = string<br/>    }))<br/>    user_hosted = optional(object({<br/>      hosted_zone_id  = string<br/>      domain          = string<br/>      certificate_arn = string<br/>    }))<br/>  })</pre> | n/a | yes |
